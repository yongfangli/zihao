...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/activity/activity/form?id=${activity.id}">活动<shiro:hasPermission name="activity:activity:edit">${not empty activity.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="activity:activity:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="activity" action="${ctx}/activity/activity/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">活动简图：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:ckeditor replace="content" uploadPath="/activity/activity" />
			</div>
		</div>
